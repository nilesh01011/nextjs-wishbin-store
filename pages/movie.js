...
function MoviePage({ newProduct, bannerImages }) {
    ...
    const bannerBoxImages = '/bannerBoxImg/movie.webp';
    const bannerVideo = '/video/movie.mp4';
    const bannerBoxTitle = 'Movie Collection'
    const bannerBoxText = "Trending Movie Collection";

    return (
        <>
            <CommonHead title="Movie PVR - WishBin Store | Online Shopping site in India" />
                        ...
                        <div className='w-full h-full'>
                            ...
                            <main className="max-w-[1366px] mx-auto w-full h-full">
                                ...
                                <div className='mb-[7.5rem] mt-[7px]'>
                                    <BannerSticker bannerImg={bannerSticker} mobileBannerSticker={mobileBannerSticker} links='/movie' bannerName='PVR Movies Collections' />
                                </div>
...
export const getServerSideProps = async () => {
    ...
    // Filter products
    const newProduct = product.filter(ele => ele.categoryTitle === "movie");
    // banner image data
