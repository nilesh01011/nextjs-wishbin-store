...
function ClothsPage({ newProduct, bannerImages }) {
    ...
    const bannerSticker = '/bannerSticker/Fashion_Add.webp';
    const mobileBannerSticker = '/bannerSticker/Mobile_Fashion_Add.webp';
    const bannerVideo = '/video/Cloths_BabyCloths.mp4';
    const bannerBoxImages = '/bannerBoxImg/cloths.webp';
    const bannerBoxTitle = 'Cloths 2023'
    const bannerBoxText = "New Fashion Collection"

    return (
        <>
            <CommonHead title="Cloths Products - WishBin Store | Online Shopping site in India" />
                        ...
                        <div className='w-full h-full'>
                            ...
                            <main className="max-w-[1366px] mx-auto w-full h-full">
                                ...
                                <div className='mb-[7.5rem] mt-[7px]'>
                                    <BannerSticker bannerImg={bannerSticker} mobileBannerSticker={mobileBannerSticker} links='/cloths' bannerName='Fashions Collections 2023' />
                                </div>
...
export const getServerSideProps = async () => {
    ...
    // Filter products
    const newProduct = product.filter(ele => ele.categoryTitle === "cloths");
    // banner image data
    const bannerImageQuery = `*[_type == 'bannerImage']`;
    const bannerImage = await client.fetch(bannerImageQuery);
    // Filter banners
    const bannerImages = bannerImage.filter(ele => ele.links === "/cloths");
